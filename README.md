# InfoSpeechNet: Informativeness-Aware Multimodal Fusion with Speech and Language Foundation Models for Alzheimer's Disease Detection

This repository contains the official implementation of **InfoSpeechNet**, a multimodal framework for Alzheimer's disease (AD) detection using speech and language foundation models.

The complete source code and related resources will be publicly released upon acceptance of the manuscript.
...
Additional dependencies will be provided together with the released code.
